...
class SelectedFavItem extends StatefulWidget {
  const SelectedFavItem({Key? key}) : super(key: key);

  @override
  _SelectedFavItemState createState() => _SelectedFavItemState();
}

class _SelectedFavItemState extends State<SelectedFavItem> {
  @override
        ...
        children: [
          Expanded(
            child: ListView.builder(
              itemCount: myFavList.selectedItem.length,
